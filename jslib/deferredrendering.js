...
var DeferredRendering = (function () {
    ...
    DeferredRendering.prototype.update = function (gd, camera, scene, currentTime) {
        ...
        globalTechniqueParameters['viewDepth'] =
            md.v4Build(-viewMatrix[2] * maxDepthReciprocal, -viewMatrix[5] * maxDepthReciprocal, -viewMatrix[8] * maxDepthReciprocal, -viewMatrix[11] * maxDepthReciprocal, globalTechniqueParameters['viewDepth']);
