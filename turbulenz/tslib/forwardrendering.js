...
var ForwardRendering = (function () {
    ...
    ForwardRendering.prototype.directionalLightsUpdateVisibleRenderables = function (gd) {
        var globalDirectionalLights = this.globalDirectionalLights;
    ...
    ForwardRendering.prototype.drawAmbientPass = function (gd, ambientColor) {
        ...
        gd.drawArray(this.passes[this.passIndex.ambient], [this.globalTechniqueParameters,
