    ...
    DefaultRendering.defaultPrepareFn = function (geometryInstance) {
        ...
        if (skinController) {
            ...
            drawParameters.sortKey =
                -renderingCommonSortKeyFn(this.techniqueIndex, skinController.index, sharedMaterial.meta.materialIndex);
        }
        else {
            drawParameters.sortKey =
                renderingCommonSortKeyFn(this.techniqueIndex, sharedMaterial.meta.materialIndex, rendererInfo.id);
        }
