...
var ShadowMapping = (function () {
    ...
    ShadowMapping.prototype.drawShadowMap = function (cameraMatrix, minExtentsHigh, lightInstance) {
        ...
        shadowMapTechniqueParameters['shadowDepth'] =
            md.v4Build(0, 0, -maxDepthReciprocal, -minLightDistance * maxDepthReciprocal, shadowMapTechniqueParameters['shadowDepth']);
    ...
    ShadowMapping.create = function (gd, md, shaderManager, effectsManager, sizeLow, sizeHigh) {
