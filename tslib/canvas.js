...
var CanvasContext = (function () {
    ...
    CanvasContext.prototype.createPattern = function (image) {
        if (!image) {
    ...
    CanvasContext.prototype.drawSystemFocusRing = function () {
    };
    CanvasContext.prototype.drawCustomFocusRing = function () {
        return false;
    };
...
var Canvas = (function () {
    ...
    Canvas.prototype.toBlob = function (fileCallback) {
        if (fileCallback) {
            var pixelData = this.context.gd.getScreenshot(true, 0, 0, this.width, this.height);
