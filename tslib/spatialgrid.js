...
var SpatialGridNode = (function () {
    function SpatialGridNode(extents, cellExtents, id, externalNode) {
    ...
    SpatialGridNode.prototype.clear = function () {
        this.queryIndex = -1;
...
var SpatialGrid = (function () {
    function SpatialGrid(extents, cellSize) {
    ...
    SpatialGrid.prototype.add = function (externalNode, extents) {
        ...
        debug.assert(0 <= minX && maxX < numCellsX &&
            0 <= minRow && maxRow < this.cells.length, "Node is out of bounds.");
        cellExtents[0] = minX;
    ...
    SpatialGrid.prototype.update = function (externalNode, extents) {
        ...
        if (index !== undefined) {
            ...
            debug.assert(0 <= newMinX && newMaxX < numCellsX &&
                0 <= newMinRow && newMaxRow < this.cells.length, "Node is out of bounds.");
    ...
    SpatialGrid.prototype._addToCells = function (node, minX, minRow, maxX, maxRow) {
        var numCellsX = this.numCellsX;
        var cells = this.cells;
        do {
            var ci = (minX + minRow);
    ...
    SpatialGrid.prototype._removeFromCells = function (node, minX, minRow, maxX, maxRow) {
        var numCellsX = this.numCellsX;
        var cells = this.cells;
        do {
            var ci = (minX + minRow);
    ...
    SpatialGrid.prototype.getSphereOverlappingNodes = function (center, radius, overlappingNodes) {
        if (0 < this.numNodes) {
    ...
    SpatialGrid.prototype.getOverlappingPairs = function (overlappingPairs, startIndex) {
        var numInsertions = 0;
        if (0 < this.numNodes) {
    ...
    SpatialGrid.prototype.getExtents = function () {
        return this.extents;
    };
    SpatialGrid.prototype.getCells = function () {
        return this.cells;
    };
    SpatialGrid.prototype.getCellSize = function () {
    ...
    SpatialGrid.create = function (extents, cellSize) {
        return new SpatialGrid(extents, cellSize);
    };
    SpatialGrid.version = 1;
    return SpatialGrid;
})();
;
(function () {
