...
var Parser = (function () {
    ...
    Parser.parseSystemAttribute = function (error, defn) {
        ...
        var parseInterpolator = Parser.parseInterpolator.bind(null, error, "system attribute" + printNames +
    ...
    Parser.parseParticle = function (error, defn) {
        ...
        var fps = Parser.maybeField(defn, "fps", Parser.checkNumber.bind(null, error, "particle" + printName, "fps"), function () { return 30; });
        if (fps !== null && fps <= 0.0) {
...
var ParticleBuilder = (function () {
    ...
    ParticleBuilder.checkAssignment = function (error, objx, objt, value, type) {
        ...
        switch (type) {
            ...
            default:
                if (value.length !== 1) {
                    error.error("Cannot type " + ParticleBuildError.wrap(value) + " with type texture" + type +
                        " for " + objt + " in " + objx);
                }
        }
    };
...
var DefaultParticleUpdater = (function () {
    ...
    DefaultParticleUpdater.prototype.createUserData = function (params) {
        return ((params.randomizeAcceleration !== undefined ? params.randomizeAcceleration : 0) << 24) |
...
var DefaultParticleRenderer = (function () {
    ...
    DefaultParticleRenderer.parseArchetype = function (error, delta) {
        ...
        Parser.extraFields(error, "default renderer archetype", delta, ["animatedRotation", "animatedOrientation", "animatedScale", "animatedAlpha",
    ...
    DefaultParticleRenderer.create = function (graphicsDevice, shaderManager, blendMode) {
        if (blendMode === void 0) { blendMode = "alpha"; }
...
var ParticleSystem = (function () {
    ...
    ParticleSystem.parseArchetype = function (error, delta) {
        ...
        Parser.extraFields(error, "system archetype", delta, ["center", "halfExtents", "maxSpeed", "maxParticles", "maxParticles", "zSorted",
        ...
        if (!ret.renderer) {
            if (!ParticleSystem.sharedDefaultRenderer) {
                ParticleSystem.sharedDefaultRenderer =
                    DefaultParticleRenderer.create(params.graphicsDevice, params.shaderManager, "alpha");
            }
        ...
        if (!ret.updater) {
            if (!ParticleSystem.sharedDefaultUpdater) {
                ParticleSystem.sharedDefaultUpdater =
                    DefaultParticleUpdater.create(params.graphicsDevice, params.shaderManager);
            }
    ...
    ParticleSystem.prototype.render = function (view) {
    ...
    DefaultParticleEmitter.parseArchetype = function (error, delta, particles) {
        ...
        return {
            ...
            particle: Parser.runField(error, "default emitter", delta, "particle", function (delta) {
                ...
                Parser.extraFields(error, "default emitter archetype particle", delta, ["lifeTimeMin", "lifeTimeMax", "renderUserData", "updateUserData", "useAnimationLifeTime",
            ...
            position: Parser.maybeField(delta, "position", function (delta) {
                ...
                Parser.extraFields(error, "default emitter archetype position", delta, ["position", "spherical", "normal", "radiusMin", "radiusMax",
            ...
            velocity: Parser.maybeField(delta, "velocity", function (delta) {
                ...
                Parser.extraFields(error, "default emitter archetype velocity", delta, ["theta", "phi", "speedMin", "speedMax", "flatSpread", "flatSpreadAngle",
...
var ParticleManager = (function () {
    ...
    ParticleManager.prototype.destroyInstance = function (instance, removedFromQueue) {
        if (removedFromQueue === void 0) { removedFromQueue = false; }
